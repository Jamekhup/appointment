...
const CreatePayment = ({ show, close, maxWidth, handleCreate, patient }) => {
    ...
    const [newCoveredByInsuranceCompany, setNewCoveredByInsuranceCompany] = useState('');
            ...
            <div className="h-[500px] overflow-y-scroll">
                ...
                <div className="flex justify-center items-center my-2 text-xs">
                    <div className="flex gap-3">
                        <div 
                        className={toggleForm == false ? "bg-slate-800 text-slate-200 px-2 py-1 rounded-md cursor-pointer" : "px-2 py-1 rounded-md cursor-pointer border border-gray-200 bg-slate-200"}
                        onClick={() => setToggleForm(false)}
                        >
                            Existed Patient
                        </div>
                        <div
                        className={toggleForm == true ? "bg-slate-800 text-slate-200 px-2 py-1 rounded-md cursor-pointer" : "px-2 py-1 rounded-md cursor-pointer border border-gray-200 bg-slate-200"}
            ...
            
            {
                    !toggleForm ? (
                        ...
                        <form onSubmit={submitNew} className="p-3 text-sm">
                            ...
                            <div>
                                <p className="mb-3 font-semibold border-b border-blue-300">Paitent Information</p>
                                    <div
                            ...
                            <div className="mt-4">
                                <p className="mb-3 font-semibold border-b border-blue-300">Payment Record</p>
                                    ...
                                    <div className="grid md:grid-cols-2 gid-cols-1 gap-2.5 items-start">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <TextInput
                                                ...
                                                onChange={(e) => setNewAdditionalPayment(e.target.value)}
                                                placeholder="Additonal Payment"
                                            />
                                        </div>
                                        <div className="flex flex-col">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <TextInput
                                                ...
                                                step="any"
                                                value={newCost3}
                                                onChange={(e) => setNewCost3(e.target.value)}
                                                placeholder="Cost 3"
                                            />
                                        </div>
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <TextInput
                                                ...
                                                onChange={(e) => setNewAdditionalPayment4(e.target.value)}
                                                placeholder="Additonal Payment 4"
                                            />
                                        </div>
