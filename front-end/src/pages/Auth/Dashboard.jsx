...
import { faUsers,faCalendarCheck,faClipboard, faCoins } from "@fortawesome/free-solid-svg-icons";
        ...
        return (
            <>
                ...
                <div className="flex md:flex-row flex-col md:justify-between justify-start gap-3 items-center mb-2">
                    <p className="text-slate-600 md:text-base text-sm">Dashboard</p>
                </div>
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-3 items-center">
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-between p-2 rounded-md bg-amber-200 text-center drop-shadow-md">
                            ...
                            <div className="text-slate-600">
                                <p className="text-base font-semibold">Total Patient</p>
                                <p className="text-sm font-mono">{Number(totalPatient).toLocaleString()}</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-between p-2 rounded-md bg-cyan-200 text-center drop-shadow-md">
                            <FontAwesomeIcon icon={faCalendarCheck} className="text-4xl text-gray-600"/>
                            <div className="text-slate-600">
                                <p className="text-base font-semibold">Total Appoitment</p>
                                <p className="text-sm font-mono">{Number(totalAppointment).toLocaleString()}</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-between p-2 rounded-md bg-blue-200 text-center drop-shadow-md">
                            <FontAwesomeIcon icon={faClipboard} className="text-4xl text-gray-600"/>
                            <div className="text-slate-600">
                                <p className="text-base font-semibold">Total Payment Record</p>
                                <p className="text-sm font-mono">{Number(totalPaymentRecord).toLocaleString()}</p>
                            </div>
                        </div>
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-between p-2 rounded-md bg-cyan-200 text-center drop-shadow-md">
                            <FontAwesomeIcon icon={faCoins} className="text-4xl text-gray-600"/>
                            <div className="text-slate-600">
                                <p className="text-base font-semibold">Total Income</p>
                                <p className="text-sm font-mono">€ {Number(totalIncome).toLocaleString()}</p>
                            </div>
                        </div>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-4 items-start my-4">
                    ...
                    <div className="w-full">
                        <p className="text-slate-600 text-sm border-b border-blue-100 mb-2">Active Appointment Lists</p>
                            ...
                            
                            {
                                activeAppointment ? (
                                    activeAppointment.map((data,i) => 
                                        ...
                                        >
                                            <td className="border border-separate py-1 pl-2">
                                                {data.patient.title} {data.patient.first_name} {data.patient.last_name}
                                            </td>
                                            <td className="border border-separate py-1 pl-2">
                                                {data.doctor_name}
                                            </td>
                                            ...
                                            <td className="border border-separate pl-2">
                                                {data.created_at.replace(/T|.000000Z/gi, ' ')}
                                            </td>
                                    ...
                                    <tr
                                        className="font-normal"
                                    >
                                        <td colSpan={6} className="border border-separate py-1 pl-2">
                                            No Data
                                        </td>
                                    </tr>
                    ...
                    <div className="w-full">
                        <p className="text-slate-600 text-sm border-b border-blue-100 mb-2">Reserved Date Time (This Week)</p>
                        <table className="w-full table-fixed">
                            ...
                            
                            {
                                reservedDateTime ? (
                                    ...
                                    <tr
                                        className="font-normal"
                                    >
                                        <td colSpan={5} className="border border-separate py-1 pl-2">
                                            No Data
                                        </td>
                                    </tr>
                                )
